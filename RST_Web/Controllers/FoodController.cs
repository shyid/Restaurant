...
namespace RST_Web.Controllers
{
    ...
    public class FoodController : Controller
    {
        ...
        public async Task<IActionResult> IndexFood()
        {
            ...
            var response = await _FoodService.GetAllAsync<APIResponse>(HttpContext.Session.GetString(SD.SessionToken));
        ...
        public async Task<IActionResult> CreateFood(FoodDTO model)
        {
        ...
        public async Task<IActionResult> UpdateFood(int FoodId)
{
            ...
            if (response != null && response.IsSuccess)
            {
                ...
                return View(_mapper.Map<FoodDTO>(model));
            }
            return NotFound();
        }
        [Authorize(Roles = "admin")]
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> UpdateFood(FoodDTO model)
        {
            if (ModelState.IsValid)
            {
